...
public class CalendarFactory {
    ...
    static SeasonIdentifier season128=new SeasonSolar128();
    static SeasonIdentifier seasonJalali=new SeasonJalali();
    static SeasonIdentifier seasonfalak=new SeasonSunCalc();
    ...
    public List<BasicCalendar> getCalendars() {
        ...
        cal.add(calMap.get(BasicCalendar.UMM_ALQURA_CALENDAR));
    ...
    public static void test(BasicDate bd) {
        //    if(true)return;
    ...
    public static String format(BasicDate selected) {
        return selected.getCalendar().getShortName() + " " + selected.getYear() + " " + selected.getCalendar().getMonthName(selected) + " " + selected.getDay();
    }
