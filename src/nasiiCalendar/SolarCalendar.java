...
public abstract class SolarCalendar extends MyBasicCalendar implements BasicCalendar{
    ...
    public SolarCalendar(String eng,  String shE, long cycleTime, int cycleYear, long matchTime, int matchYear) {
    ...
    public PeriodType getMonthName(BasicDate bd) {
        PeriodType yt=bd.getCalendar().getYearType(bd);
        return yt.getSubPeriods().get(bd.getMonth()-1);
