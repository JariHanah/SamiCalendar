...
public class BasicYear extends PeriodStore implements PeriodType {
    ...
    String engName, shortName;
    List<PeriodType> months;
    int length;

    public BasicYear(String en, String shortName, boolean smallLeap, boolean bigLeap, PeriodType[] months) {
        super(en,shortName, smallLeap, bigLeap, months);
        engName = en;
