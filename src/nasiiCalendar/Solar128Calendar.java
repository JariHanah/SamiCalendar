...
//    private static final long STARTTIME=-CYCLE128*31266;
    ...
    private static final long BASE_TIME = 978382799999L;//-126289975230000000l;//-62135521200001l ;//- DAY*4000 * (((365*3+366)*100)-3);
    
    public Solar128Calendar() {
        super(BasicCalendar.SOLAR_128_ID, "S.AD", CYCLE128, 128, BASE_TIME, BASE_YEAR);
    }
