...
public class Zodiac13Calendar extends SolarCalendar {
    ...
    private static final long STARTTIME= 978382799999L-15*DAY;
    private static final int STARTYEAR= 2001;
    
    static final BasicYear Y_NORMAL=new BasicYear("Zodiac Year", "Zodiac Year", false, false, new PeriodType[]{
    ...
    static final BasicYear Y_LEAP=new BasicYear("Zodiac Leap Year", "Zodiac Leap Year", true, false, new PeriodType[]{
    ...
    public Zodiac13Calendar() {
        super(BasicCalendar.ZODIAC13_ID, "Z13", BasicCalendar.YEAR_SIDEREAL*4, 4, STARTTIME, STARTYEAR);
