...
public class SamiFixed extends SolarCalendar implements BasicCalendar {
    ...
    private static final long STARTTIME = START_SAMI+DAY;

    PeriodStore store;
    static final BasicYear Y0_N = new BasicYear("Luner Year", "Luner Year Short", false, false,
    ...
    static final BasicYear Y0_L = new BasicYear("Small Leap Year", "Small Leap Year Short", true, false,
            new PeriodType[]{new LeapMonth(30, Months.SAFAR), Months.SAFAR2, Months.RABEI1, Months.RABEI2, Months.JAMAD1, Months.JAMAD2,
                Months.RAJAB, Months.SHAABAN, Months.RAMADHAN, Months.SHAWWAL, Months.THO_QIDAH, new LeapMonth(30, Months.THO_HIJA)});
    static final BasicYear Y13 = new BasicYear("Big Hajj Leap Year", "Big Hajj Leap Year", false, true,
            new PeriodType[]{new LeapMonth(30, Months.SAFAR), Months.SAFAR2, Months.RABEI1, Months.RABEI2, Months.JAMAD1, Months.JAMAD2,
                Months.RAJAB, Months.SHAABAN, Months.RAMADHAN, Months.SHAWWAL, Months.THO_QIDAH, Months.THO_HIJA, Months.ALHARAM});
    static final BasicYear Y9 = new BasicYear("Modhar Leap Year", "Modhar Leap Year", false, true,
            new PeriodType[]{new LeapMonth(30, Months.SAFAR), Months.SAFAR2, Months.RABEI1, Months.RABEI2, Months.JAMAD1, Months.JAMAD2,
                Months.RAJAB, Months.SHAABAN, Months.RAJAB_MODHAR, Months.RAMADHAN, Months.SHAWWAL, Months.THO_QIDAH, Months.THO_HIJA});
    static final BasicYear Y5 = new BasicYear("Rabeah Leap Year", "Rabeah Leap Year", false, true,
    ...
    SamiFixed() {
        this(BasicCalendar.SAMI_FIXED_ID, "SH", LONG_CYCLES, BIG_CYCLE, STARTTIME, STARTDATE);
...
//        hussam.println(Y0_L);
    ...
    public SamiFixed(String eng, String shE, long cycleTime, int cycleYear, long matchTime, int matchYear) {
