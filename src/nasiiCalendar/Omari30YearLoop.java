...
public class Omari30YearLoop extends SolarCalendar{
    ...
    private static long START=-42521554800000L;
    Map<Integer, Integer>yearDuration=new  TreeMap<Integer, Integer>();
    TreeMap<Long, Integer>durationYear=new  TreeMap<Long, Integer>();
    HijriCalc30 type;
    final BasicYear Y_NORMAL=new BasicYear("Luner Year", "Luner Year", false, false, new PeriodType[]{Months.MUHARRAM, Months.SAFAR, Months.RABEI1, Months.RABEI2, Months.JAMAD1, Months.JAMAD2,
            Months.RAJAB, Months.SHAABAN, Months.RAMADHAN, Months.SHAWWAL, Months.THO_QIDAH, Months.THO_HIJA});
    final BasicYear Y_LEAP=new BasicYear("Luner Leap", "Luner Leap", true, false, new PeriodType[]{Months.MUHARRAM, Months.SAFAR, Months.RABEI1, Months.RABEI2, Months.JAMAD1, Months.JAMAD2,
    ...
    public enum HijriCalc30{
        Type16(BasicCalendar.OMARI_ID_16,"hijri16short",  new int[]{2, 5, 7, 10, 13, 16, 18, 21, 24, 26, 29}),
        Type15(BasicCalendar.OMARI_ID_15,"hijri15short", new int[]{2, 5, 7, 10, 13, 15, 18, 21, 24, 26, 29}),
        TypeHindi(BasicCalendar.OMARI_ID_INDIAN, "hijriindianshort",new int[]{2, 5, 8, 10, 13, 16, 19, 21, 24, 27, 29}),
        TypeHaseb(BasicCalendar.OMARI_ID_HABASH, "hijrihabashshort",new int[]{2, 5, 8, 11, 13, 16, 19, 21, 24, 27, 30});
        String name;
        String shortName;
        int [] leapYears;
       
        private HijriCalc30(String name,String shortName, int[] leapYears) {
            this.name = name;
    ...
    public Omari30YearLoop(HijriCalc30 type) {
        super(type.getName(), type.getShortName(), CYCLE, 30, START, 1);
        this.type=type;
        prepareYears();
