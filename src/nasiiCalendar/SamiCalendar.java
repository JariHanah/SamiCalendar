...
public class SamiCalendar extends LunerCalendar implements BasicCalendar{
   ...
   static final BasicYear Y_NORMAL=new BasicYear("Luner Year", "Luner Year", false, false, new PeriodType[] {
   ...
   static final BasicYear Y5=new BasicYear("Rabeah Leap Year", "Rabeah Leap Year", false, true, new PeriodType[] {
            Months.SAFAR, Months.SAFAR2, Months.RABEI1, Months.RABEI2, Months.RAJAB_RABEEIAH, Months.JAMAD1, Months.JAMAD2, 
            Months.RAJAB, Months.SHAABAN, Months.RAMADHAN, Months.SHAWWAL, Months.THO_QIDAH, Months.THO_HIJA});
   static final BasicYear Y9=new BasicYear("Modhar Leap Year", "Modhar Leap Year", false, true, new PeriodType[] {
            Months.SAFAR, Months.SAFAR2, Months.RABEI1, Months.RABEI2, Months.JAMAD1, Months.JAMAD2, 
            Months.RAJAB, Months.SHAABAN, Months.RAJAB_MODHAR, Months.RAMADHAN, Months.SHAWWAL, Months.THO_QIDAH, Months.THO_HIJA});
   static final BasicYear Y13=new BasicYear("Big Hajj Leap Year", "Big Hajj Leap Year", false, true, new PeriodType[] {
            Months.SAFAR, Months.SAFAR2, Months.RABEI1, Months.RABEI2, Months.JAMAD1, Months.JAMAD2, 
...
/*
    ...
    //*/
    SamiCalendar() {
        super(BasicCalendar.SAMI_ID, "SH", METONIC353, 353, STARTTIME, STARTDATE);
