...
public class JalaliCalendarIR extends SolarCalendar {
    ...
    private static final long START_MATCH = -27542257200001L;//-27573793200001L;// -27573793200001L;
    private static final int START_YEAR=476;
    public JalaliCalendarIR() {
        super(BasicCalendar.JALALI_IR_ID, "jhi", CYCLE2820, 2820, START_MATCH, START_YEAR);
    }

    public enum JalalYearType implements PeriodType {
        YNormal("Jalali Year", false,  new PeriodType[]{Months.HAMAL, Months.SAWR, Months.JAWZA, Months.SARATAN, Months.ASAD, Months.SONBOLA,
            Months.MIZAN, Months.AQRAB, Months.QAWS, Months.JADI, Months.DALW, Months.HUT}),
        YLeap("Jalali Leap", true, new PeriodType[]{Months.HAMAL, Months.SAWR, Months.JAWZA, Months.SARATAN, Months.ASAD, Months.SONBOLA,
